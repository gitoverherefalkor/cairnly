...
- [ ] Phase 4 — n8n workflows (in progress, 2026-05-30)
  ...
  - [ ] WF1 Profile Insert — NEXT. LLM nodes `Initial_summary1`, `generate_personality_narrative1` + Supabase insert (write `language` col).
  - [ ] WF3, WF4, WF_cover_letter, WF_custom_resume, WF7, feedback cluster — pending.

...
export default defineConfig(({ mode }) => ({
  ...
  test: {
    ...
    exclude: [
      ...
      'supabase/functions/_shared/outreachSchedule.test.ts',
      'supabase/functions/_shared/outreachInitial.test.ts',
      'supabase/functions/_shared/outreachRejection.test.ts',
      'supabase/functions/_shared/outreachValidate.test.ts',
      'supabase/functions/_shared/outreachMime.test.ts',

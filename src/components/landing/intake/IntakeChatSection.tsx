 ...
 * becomes the conversation: an outline of the five beats on the left
 * (desktop), the thread with tap-able answer chips on the right, and the
 * pitch, email capture and checkout handoff at the end.
 */
  ...
  return (
    <section id={INTAKE_SECTION_ID} style={{ background: '#213F4F' }}>
      <div className="lp-container pb-16 pt-2 md:pb-20">
        <Reveal as="div">
          <div
            className="mx-auto max-w-[920px] overflow-hidden rounded-3xl border shadow-2xl"
            style={{ background: '#FBF6E8', borderColor: 'rgba(201,182,144,0.6)' }}
          >
            {/* Header */}
            <div className="flex items-start justify-between px-6 py-5" style={{ background: '#122E3B' }}>
              <div>
                <p
              ...
              {chat.started && chat.stage === 'chat' && (
                <span className="rounded-full border border-white/20 px-2.5 py-1 text-[11px] font-semibold text-white/70 md:hidden">
            ...
            <div className="md:grid md:grid-cols-[230px_1fr]">
              ...
              <div
                className="hidden border-r px-5 py-5 md:block"
                style={{ borderColor: 'rgba(201,182,144,0.45)', background: 'rgba(201,182,144,0.10)' }}
              >
                      ...
                      <li key={n} className="flex items-center gap-2.5">
                        <span
                          ...
                          style={
                              ...
                              : active
                                ? { borderColor: '#D4A024', color: '#D4A024', background: 'rgba(212,160,36,0.12)' }
                                : { borderColor: 'rgba(75,99,115,0.4)', color: '#6B7F8B' }
                          }
                        >
                        ...
                        <span
                          ...
                          style={{
                            color: active ? '#122E3B' : done ? '#4B6373' : '#6B7F8B',
              ...
              <div>
                {!chat.started ? (
                  ...
                  /* Conversation state */
                  <>
                    <div ref={threadRef} className="max-h-[440px] space-y-3 overflow-y-auto px-5 py-5 md:px-6">
                      ...
                      {showChips && (
                        <div className="flex flex-wrap justify-end gap-2 pt-1">
                          {chat.chips!.options.map((option) => {
                            ...
                            return (
                              <button
                                ...
                                style={
                                  selected
                                    ? { background: '#122E3B', borderColor: '#122E3B', color: '#F4ECDA' }
                                    : { borderColor: '#2AA1A1', color: '#1F8282', background: 'rgba(42,161,161,0.06)' }
                                }
                              >
                                {option}
                              </button>
                          ...
                          <button
                            ...
                            className="rounded-full border border-dashed px-3.5 py-1.5 text-[13px] font-semibold"
                            style={{ borderColor: '#6B7F8B', color: '#6B7F8B' }}
                          >
                            {t('intake.other')}
                          </button>

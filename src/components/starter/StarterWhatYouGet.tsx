...
/** Six-card grid of everything included in the Starter report. */
const StarterWhatYouGet: React.FC = () => {
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {items.map((item, i) => (
            <Reveal key={i}>
              ...
              >
                <CheckCircle2 size={22} strokeWidth={2.2} color="#27A1A1" className="mb-5" />
                <h3
                ...
                <p className="text-[14.5px] text-[#4B6373] font-medium leading-relaxed">
                  {item.body}
                </p>
              </div>
            </Reveal>
...
export default StarterWhatYouGet;

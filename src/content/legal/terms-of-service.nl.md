...
- Uitgebreide carrière-assessments en persoonlijkheidsevaluaties
- Gepersonaliseerde rapporten en aanbevelingen voor loopbaaninzicht
- AI-ondersteunde analyse van loopbaanvoorkeuren en vaardigheden
...
- Het vertrouwelijk houden van jouw inloggegevens
- Alle activiteiten die plaatsvinden onder jouw account
- Het direct melden van onbevoegd gebruik
- Het verstrekken van juiste en actuele informatie
...
Voor toegang tot onze assessmentdiensten is een geldige toegangscode vereist. Deze kun je verkrijgen via:
...
- Alle bedragen zijn niet-restitueerbaar, tenzij anders vermeld
- Prijzen kunnen na aankondiging worden aangepast
- Betalingen worden verwerkt door beveiligde externe dienstverleners
- Toegangscodes hebben een vervaldatum zoals vermeld bij aankoop

### 4.3 Restitutiebeleid
...
- De dienst te gebruiken voor onwettige doeleinden of in strijd met geldende wetgeving
- Toegangscodes te delen met onbevoegden
- Te proberen ons platform te reverse engineeren, te hacken of te compromitteren
- Schadelijke content te uploaden of onze diensten te verstoren
- Je voor te doen als anderen of onjuiste informatie te verstrekken
...
Je behoudt het eigendom van de informatie die je verstrekt tijdens assessments. Je verleent ons echter een beperkte licentie om deze informatie te gebruiken om:

- Onze assessmentdiensten te leveren en te verbeteren
- Jouw gepersonaliseerde rapporten te genereren
- Onze AI-algoritmen (in geanonimiseerde vorm) te verbeteren

### 6.2 Assessment-rapporten
...
Cairnly biedt loopbaanbegeleiding en inzichten op basis van assessment-antwoorden. Onze diensten zijn:

- Uitsluitend bedoeld voor informatie en begeleiding
- Geen vervanging voor professionele loopbaanbegeleiding
...
- Incidentele uitval of technische problemen kunnen voorkomen
- Back-up- en herstelprocedures zijn aanwezig, maar niet gegarandeerd
...
- Schadelijk is voor andere gebruikers of onze onderneming
...
- De bijgewerkte Voorwaarden op onze website te plaatsen
- De “Laatst bijgewerkt”-datum aan te passen
- E-mailmeldingen te versturen bij belangrijke wijzigingen
